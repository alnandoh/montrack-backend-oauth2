...
import com.example.montrack.auth.service.UserDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    public SecurityConfig(RsaConfiguration rsaConfiguration, UserDetailsServiceImpl userDetailsService) {
